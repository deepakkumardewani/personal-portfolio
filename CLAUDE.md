...
1. **Never run the server** — it is always running.
2. Always use `vp install` to install node modules.
3. Always show summary at the end. See output styles below.
4. Use the AskUserQuestion tool to ask questions if you're unclear of the requirements.

## CLI Commands Reference

Use the **vp** (Vite+) CLI for installs and project tasks. Do not use pnpm, npm, or yarn for dependency installs in this repo—use `vp install` (per team workflow).
